...
sudo apt-get update
sudo apt-get install mosh gnome-panel xmonad feh trayer xautolock git tig htop \
  terminator xmobar suckless-tools gmrun xcompmgr haveged gworldclock tmux \
  shutter bat exa cargo ripgrep fzf zsh
